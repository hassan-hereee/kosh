...
export default function QuoteWizard() {
  ...
  return (
    <div
      id="quote"
      className="w-full rounded-[22px] border border-white/70 bg-surface-muted/95 px-[30px] pb-[64px] pt-[30px] shadow-[0_30px_70px_-24px_rgba(15,26,46,0.25),0_4px_14px_-6px_rgba(15,26,46,0.08)] backdrop-blur-sm sm:px-[36px] sm:pb-[84px] sm:pt-[36px]"
    >
      {/* header + progress */}
      ...
      {done ? (
        <div className="py-[54px] text-center">
